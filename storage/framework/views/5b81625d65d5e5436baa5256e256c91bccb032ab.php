...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('resenyas.store')); ?>" method="post" enctype="multipart/form-data" id="formulariocrearvideojuegos">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/resenya/create.blade.php ENDPATH**/ ?>