...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('resenyas.update',$resenya->id)); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="row align-self-center">
                    <div class="col col-md-4 mb-8 ">
                        <div class="form-outline">
                            ...
                            <input type="text" id="form3Example1" class="form-control  bordesredondeados " name="titulo" value="<?php echo e($resenya->titulo ?? ''); ?>"/>
                        </div>
                    </div>
                </div>
                <div class=" mb-4">
                    <div class="form-outline">
                        ...
                        <input type="text" id="form3Example2" class="form-control bordesredondeados" name="contenido" value="<?php echo e($resenya->contenido ?? ''); ?>" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/resenya/edit.blade.php ENDPATH**/ ?>