...
<head>
    ...
    <script src="<?php echo e(asset('js/eventosshow.js')); ?>"></script>
    <!-- CSRF Token -->
    ...
    <script src="<?php echo e(asset('js/indexgames.js')); ?>"></script>
...
<style>
    body {
        background-image: url('<?php echo e(asset("imagenes/fondo.jpg")); ?>');
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-dark bg-primary ">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(route('proyects.index')); ?>">
                Proyecto
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('proyects.index')); ?>">Proyecto</a>
                        </li>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            ...
                            <img src="<?php echo e(asset(Auth::user()->imagen)); ?>" style="border-radius: 50% 50% 50% 50%;width: 50px; height: 50px"/>
                            <?php else: ?>
                            <img src="<?php echo e(asset('imagenesperfil/userdefault.png')); ?>" style="border-radius: 50% 50% 50% 50%;width: 50px; height: 50px"/>
                            <?php endif; ?>
                        </li>
        ...
        <main class="py-4">
            <?php echo $__env->yieldContent('adminnavbar'); ?>
